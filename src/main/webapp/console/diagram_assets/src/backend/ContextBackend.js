limz_Backend = Class.extend({
	...
	getBotList: function(app) {
        ...
        $.when(getBotList("/console/context/" + accountId + "/", "#selectbotlist")).done(function() {
    ...
    save: function(contextId, content, successCallback, errorCallback){
        ...
        console.log("To.." + `/console/context/${contextId}`);
        
        $.ajax({
        	url: `/console/context/${contextId}`,
            type: "PUT",
            data: jsonString,
    ...
    load:  function(contextId, successCallback, errorCallback){
		...
		console.log("Loading.." + `/console/context/${contextId}`);
		
        $.get(`/console/context/${contextId}`, function(data, status) {
