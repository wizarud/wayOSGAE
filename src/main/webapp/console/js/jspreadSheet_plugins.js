	...
	openEditor : function(cell) {
		...
		$(cell.input).change(function() {
			...
			$.ajax({
				...
				cell.innerHTML = "https://" + window.location.hostname + "/public/" + accountId + "/" + encodeURI(file.name);
...
function cellUpload(file, input) {
	...
	$.ajax({
		...
		const imageURL = "https://" + window.location.hostname + "/public/" + accountId + "/" + encodeURI(file.name);
