...
function loadReport() {
    ...
    $.get("/console/vars/" + contextName(botId) + "?start=" + start + "&end=" + end, function(dates, status) {
    	...
    	dates.forEach(function(date) {
    		...
    		row.click(function() {
    			...
    			overlayPopup('loader');
    		    $.get("/console/vars/" + contextName(botId) + "?date=" + date, function(unordered_vars, status) {
